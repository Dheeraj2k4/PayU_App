...
export function StarSvgIcon({ filled = false }: { filled?: boolean }) {
  const fillColor = filled ? '#A1A1A1' : 'none';
  const strokeColor = filled ? '#A1A1A1' : '#A1A1A1';
  return (
